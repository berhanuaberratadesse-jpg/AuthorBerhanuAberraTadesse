    ...
    <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4">
      <div className="bg-slate-800 rounded-2xl shadow-2xl max-w-2xl w-full overflow-hidden">
        <div className="bg-gradient-to-r from-slate-900 to-slate-800 text-white p-6 flex justify-between items-center relative z-[70]">
          <h2 className="text-2xl font-bold">Select Your Edition</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-8">
          <div className="mb-8">
            <h3 className="text-lg font-semibold text-white mb-4">Choose Edition:</h3>
          ...
          <div className="mb-8">
            ...
            <div className="flex items-center gap-4">
              <button
                ...
                className="p-2 hover:bg-slate-600 rounded-lg transition border border-slate-500 text-white"
              >
                <Minus size={20} />
              </button>
          ...
          <div className="space-y-3">
            <button
              ...
              className="w-full bg-amber-500 text-white font-bold py-3 rounded-lg hover:bg-amber-600 transition transform hover:scale-105"
            >
              Add to Cart
            </button>
            <button
